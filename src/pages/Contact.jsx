  ...
  return (
    <section className="w-full">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="mt-2 text-2xl font-bold leading-tight tracking-tight text-slate-900 sm:text-3xl lg:text-4xl">
          Empowering Your Brand Through Creative Tech
        </h2>

        <p className="mx-auto mb-4 mt-4 max-w-2xl text-balance text-center text-base leading-relaxed text-slate-500 sm:mt-5 sm:text-lg md:text-xl">
          We combine cutting-edge web development, data-driven marketing, bold
          graphic design, and impactful video editing to accelerate your
          business growth.
        </p>
